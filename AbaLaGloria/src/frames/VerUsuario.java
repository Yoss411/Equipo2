...
public class VerUsuario extends javax.swing.JFrame {
     ...
     * @param idUsuario
     */
    public VerUsuario(int idUsuario) {
        initComponents();
        this.idUsuarioSeleccionado = idUsuario;
        cargarDatosUsuario(idUsuario); // aquí llenas los campos
        System.out.println("Abriendo VerUsuario con ID: " + idUsuario);
        ImageIcon icono=new ImageIcon(getClass().getResource("/imagenes/ojo.png"));
        Image imagenEscalada=icono.getImage().getScaledInstance(40, 40, Image.SCALE_SMOOTH);
        ImageIcon iconoFinal = new ImageIcon(imagenEscalada);
        lblFondo.setIcon(iconoFinal);
        cargarGeneros();
        deshabilitarCampos();
        ImageIcon iconoA = new ImageIcon(getClass().getResource("/imagenes/mas-informacion.png"));
        Image imagenAct = iconoA.getImage().getScaledInstance(32, 32, Image.SCALE_SMOOTH);
        ImageIcon iconoEditar = new ImageIcon(imagenAct);
        btnEditarInfo.setIcon(iconoEditar);
        btnEditarInfo.setText("Editar Información");
        btnEditarInfo.setHorizontalTextPosition(SwingConstants.RIGHT);  // Texto a la derecha del ícono
        btnEditarInfo.setVerticalTextPosition(SwingConstants.CENTER); 
...
System.out.println("Clase del child: " + item.getChildren().get(0).getClass().getName());
   ...
   private void deshabilitarCampos() {
    ...
    // Deshabilitar y cambiar color automáticamente a gris
    txtNombre.setEnabled(false);
    txtAPater.setEnabled(false);
    txtAMater.setEnabled(false);
    ...
    try {
        ...
        if (rsUsuario != null && rsUsuario.next()) {
            ...
            // Rol
            int idRol = rsUsuario.getInt("id_rol");
            ResultSet rsRol = conexion.buscarPorId("rol", "id_rol", idRol);
            if (rsRol != null && rsRol.next()) {
                comboRol.setSelectedItem(rsRol.getString("nombre_rol"));
                rsRol.close();
            }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ver Información del Usuario");
        ...
        btnEditarInfo.setBackground(new java.awt.Color(237, 198, 142));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(46, 46, 46)
                        .addComponent(btnEditarInfo, javax.swing.GroupLayout.PREFERRED_SIZE, 212, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(22, 22, 22))))
        );
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(27, 27, 27))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addComponent(btnEditarInfo, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)))
    ...
    private void btnEditarInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarInfoActionPerformed
        // TODO add your handling code here:
        new EditarInfoUsu(idUsuarioSeleccionado).setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                int idUsuario=0;
                new VerUsuario(idUsuario).setVisible(true);
            }
        });
    }
    ...
    private CaptchaPanel captcha1;
    private CaptchaPanel captcha2;
